<!-- Banner
================================================== -->
<div id="banner" style="background: url(<?php echo base_url();?>assets/images/banner-home-01.jpg)">
    <div class="container">
    ...
    <div class="padding-right">
        ...
        <ul class="job-list">
            ...
            <li class="highlighted"><a href="job-page.html">
                <img src="<?php echo base_url();?>assets/images/job-list-logo-01.png" alt="">
            ...
            <li><a href="job-page.html">
                <img src="<?php echo base_url();?>assets/images/job-list-logo-02.png" alt="">
                <div class="job-list-content">
            ...
            <li><a href="job-page.html">
                <img src="<?php echo base_url();?>assets/images/job-list-logo-03.png" alt="">
                <div class="job-list-content">
            ...
            <li><a href="job-page.html">
                <img src="<?php echo base_url();?>assets/images/job-list-logo-04.png" alt="">
                <div class="job-list-content">
            ...
            <li><a href="job-page.html">
                <img src="<?php echo base_url();?>assets/images/job-list-logo-05.png" alt="">
                <div class="job-list-content">
...
<div class="container">
    ...
    <div class="one-third column">
        ...
        <div class="recent-post">
            <div class="recent-post-img"><a href="blog-single-post.html"><img src="<?php echo base_url();?>assets/images/recent-post-01.jpg" alt=""></a><div class="hover-icon"></div></div>
    ...
    <div class="one-third column">
        ...
        <!-- Post #2 -->
        <div class="recent-post">
            <div class="recent-post-img"><a href="blog-single-post.html"><img src="<?php echo base_url();?>assets/images/recent-post-02.jpg" alt=""></a><div class="hover-icon"></div></div>
    ...
    <div class="one-third column">
        ...
        <!-- Post #3 -->
        <div class="recent-post">
            <div class="recent-post-img"><a href="blog-single-post.html"><img src="<?php echo base_url();?>assets/images/recent-post-03.jpg" alt=""></a><div class="hover-icon"></div></div>
