<footer id="footer" role="contentinfo" data-role="footer" data-fullscreen="true">
			<div data-parallax="no" data-scroll-btn="no" data-alignment="top"  class="site-section  has-row-mask "  style=" background-color: #190e58;  color: #ffffff;  background-image:url('images/footer_bg.jpg') ;  background-position: center center;  background-attachment: scroll;  background-repeat: repeat;  margin-top: 40px;  margin-bottom: 0px;  padding-top: 50px;  padding-bottom: 20px;  background-size: cover; " ><div class="row-mask" style="
							background: #202737;
							background: -moz-linear-gradient(left, #202737 0%,  #190e36 0%, #202737 100%, #190e36 100%);
							background: -webkit-gradient(linear, left top, right top, color-stop(0%,#202737), color-stop(0%, #190e36), color-stop(100%,#202737), color-stop(100%,#190e36));
							background: -webkit-linear-gradient(left, #202737 0%, #190e36 0%,#202737 100%,#190e36 100%);
							background: -o-linear-gradient(left, #202737 0%, #190e36 0%,#202737 100%,#190e36 100%);
...
<div style="background-color: transparent;color: inherit;background-position: left;background-attachment: scroll;background-repeat: repeat;background-size: auto;padding-top: 0px;padding-right: 20px;padding-left: 20px;padding-bottom: 0px;text-align: auto;" class="col-lg-3 col-md-3">
		...
		<h6 class="widget-title ts_sidebar_title">Top liked videos</h6><div class="widget-delimiter"></div>                <ul class="widget-items row  widget-columns-2 widget-has-image">                    <li class="col-lg-6 col-md-6 col-sm-12">
						...
						<article class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
	                                <a  class="entry-img" href="#"><img width="450" height="300" src="images/Screen-Shot-2015-04-14-at-6.05.01-PM-450x300.jpg" class="attachment-grid size-grid" alt="Screen-Shot-2015-04-14-at-6.05.01-PM" /></a>
	                            </div>
	                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                            	                            	<div class="entry-content">
	                                <h4 class="title">
...
<!-- Mirrored from demo.touchsize.com/slimvideo/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2016 02:32:21 GMT -->
</html>