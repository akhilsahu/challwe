...
<div class="container">
	...
	<form method="POST" action="<?php echo site_url()."/artist/addContest";?>" enctype="multipart/form-data">
		<div class="submit-page">
			...
			<div class="form">
				<h5>Description</h5>
				<textarea class="WYSIWYG" name="txt_description" cols="35" rows="3" id="summary" spellcheck="true"></textarea>
			</div>
...
<!-- WYSIWYG Editor -->
<script type="text/javascript" src="<?php echo base_url();?>assets/scripts/jquery.sceditor.bbcode.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/scripts/jquery.sceditor.js"></script>
<script>
