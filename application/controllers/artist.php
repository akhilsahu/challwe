...
class Artist extends CI_Controller {
    ...
    function accountDetails() {
        ...
        $data['directory'] = $this->fields_model->allActiveDirectorylist();
        $data['countries'] = $this->location_model->get_all_countries();
        if ($data['user_details']['int_country_id'])
            $data['states'] = $this->location_model->getStatesByCountry($data['user_details']['int_country_id']);
        if ($data['user_details']['int_state_id'])
            $data['cities'] = $this->location_model->getCityByState($data['user_details']['int_state_id']);
